...
- backtester_tickm.py는 전략 변수값을 고정하여 백테스트할 수 있습니다.
...
2. collector 폴더내에는 틱데이터 수집코드 및 일봉데이터 다운로더가 포함되어 있습니다.
...
- 자동매매프로그램 종료 후 매주 금요일만 일봉데이터 다운로드 실행
- 단기 전략용 업데이터 실행
- 초단타 전략 변수 최적화용 백테스터 실행
- 프로그램 종료
## 설정방법
