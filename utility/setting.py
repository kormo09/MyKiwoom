...
ui_num = {'거래합계': 1, '거래목록': 2, '잔고평가': 3, '잔고목록': 4, '체결목록': 5, '기업공시': 6,
          ...
          '당일합계': 13, '당일상세': 14, '누적합계': 15, '누적상세': 16, '단타설정': 17, 'tick': 18, 'short': 19,
...
columns_gjt1 = ['등락율', '고저평균대비등락율', '거래대금', '누적거래대금', '체결강도', '최고체결강도']
columns_gjt2 = ['등락율', '고저평균대비등락율', '거래대금', '누적거래대금', '체결강도']
columns_gjt3 = ['종목명', 'per', 'hmlper', 'smoney', 'dmoney', 'ch', 'smavg', 'chavg', 'chhigh']
columns_gjs = ['종목명', '등락율', '현재가', '시가', '고가', '저가', '변동성']
